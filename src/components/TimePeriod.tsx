...
export const TimePeriod = () => {
  ...
  return (
    <div className="px-4 mb-6">
      {/* Outer Box with thicker light grey border */}
      <div className="border-2 border-gray-200 rounded-xl shadow-sm p-4 bg-white">
        {/* Header with left and right alignment */}
        <div className="mb-4 flex items-center justify-between">
          <span className="text-gray-600 text-lg font-medium">Time Period</span>
          <span className="text-gray-400 text-lg">dd:mm:yyyy - dd:mm:yyyy</span>
        </div>
